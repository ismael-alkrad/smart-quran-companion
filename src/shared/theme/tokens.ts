...
export const semanticColors = {
  ...
  'QuranState/Memorizing/Background': { light: '#f4f6fa', dark: '#22252a' },
  'QuranState/Memorizing/Foreground': { light: '#536f9f', dark: '#bac7de' },
  ...
  'QuranState/NeedsReview/Background': { light: '#fffbeb', dark: '#2b2415' },
  'QuranState/NeedsReview/Foreground': { light: '#92400e', dark: '#fcd34d' },
  'QuranState/Mastered/Background': { light: '#bde4d8', dark: '#10271f' },
  'QuranState/Mastered/Foreground': { light: '#0e3529', dark: '#bde4d8' },

  'AI/Active/Background': { light: '#f4f6fa', dark: '#22252a' },
  'AI/Active/Foreground': { light: '#536f9f', dark: '#bac7de' },
